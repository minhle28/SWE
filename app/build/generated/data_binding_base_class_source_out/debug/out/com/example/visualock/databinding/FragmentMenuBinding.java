...
public final class FragmentMenuBinding implements ViewBinding {
  ...
  private FragmentMenuBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listMenu) {
  ...
  public static FragmentMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.list_menu;
      ListView listMenu = ViewBindings.findChildViewById(rootView, id);
      if (listMenu == null) {
        break missingId;
      }

      return new FragmentMenuBinding((ConstraintLayout) rootView, listMenu);
    }
