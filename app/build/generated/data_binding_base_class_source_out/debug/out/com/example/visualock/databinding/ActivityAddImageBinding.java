...
public final class ActivityAddImageBinding implements ViewBinding {
  ...
  private ActivityAddImageBinding(@NonNull RelativeLayout rootView, @NonNull ImageView backButton,
      @NonNull ImageView imageView, @NonNull Button selectImageButton,
  ...
  public static ActivityAddImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddImageBinding((RelativeLayout) rootView, backButton, imageView,
          selectImageButton, uploadImageButton);
    }
